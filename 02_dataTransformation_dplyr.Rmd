...
With `?gapminder` you can find out more about the gapminder dataset. Notice that the gaminder dataset is stored as a tibble, a modern take on data frames. Use `?tibble` to find out more about tibbles. 
...
## Two criteria: Country equals Germany and population greater than 80 MM.
